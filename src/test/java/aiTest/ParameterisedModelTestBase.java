...
import uk.ac.bris.cs.scotlandyard.ui.ai.ModelFactories;
...
@RunWith(Parameterized.class) abstract class ParameterisedModelTestBase {
	...
	@Parameter(0) public Factory<GameState> gameStateFactory;
	@Parameter(1) public Factory<Model> modelFactory;
